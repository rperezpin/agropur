...
const CONTACT_EMAIL = "info@agropur.es";
const JOB_EMAIL = "rrhh@agropur.es";
const FROM_EMAIL = "dev@agropur.es";
...
async function sendApplicationNotification(data) {
  ...
  await transporter.sendMail({
    ...
    attachments: data.cvBuffer ? [{
      filename: data.cvFilename || "curriculum.pdf",
...
export { sendContactNotification as a, sendApplicationNotification as s };
